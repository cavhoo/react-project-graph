 ...
 */
export declare function copyAndExtendArray<T>(arr: T[], newValue: T): T[];
/**
 * Used to extend an array and copy it. This is used to propagate paths recursively.
 *
...
export declare function parseColor(inputColor: ColorObject | string, defaultColor: FullColorObject): FullColorObject;
/**
